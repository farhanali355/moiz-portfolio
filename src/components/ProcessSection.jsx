...
const steps = [
  {
    ...
    icon: <img src="/section-4-images/brief.png" alt="Brief" className="step-img-icon" />
  },
  {
    step: 'Step 2',
    title: 'Research',
    ...
    icon: <img src="/section-4-images/research.png" alt="Research" className="step-img-icon" />
  },
  {
    step: 'Step 3',
    title: 'Design',
    desc: 'With the strategy in place, I turn the idea into packaging that feels clear, compelling, and hard to scroll past.',
    icon: <img src="/section-4-images/design.png" alt="Design" className="step-img-icon" />
  },
  {
    step: 'Step 4',
    title: 'Refine',
    ...
    icon: <img src="/section-4-images/refine.png" alt="Refine" className="step-img-icon" />
  },
  {
    step: 'Step 5',
    title: 'Optimize',
    ...
    icon: <img src="/section-4-images/optimize.png" alt="Optimize" className="step-img-icon" />
  }
];
